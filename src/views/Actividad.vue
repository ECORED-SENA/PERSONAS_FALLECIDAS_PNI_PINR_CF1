  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Personas fallecidas no identificadas (PNI) e identificadas no reclamadas (PINR).
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 Identificar los fundamentos y marco normativo para la gestión de las personas fallecidas no identificadas (PNI) e identificadas no reclamadas (PINR)
            .col-auto
              a.boton.boton--b(:href="obtenerLink('/actividades/Actividad_Didactica_CF1_01/story.html')" target="_blank")
                span Realizar
    ...
    //-         .col-auto
    //-           a.boton.boton--b(:href="obtenerLink('/actividades/Actividad_Didactica_CF1_02/story.html')" target="_blank")
    //-             span Realizar
    //-             i.fas.fa-puzzle-piece
